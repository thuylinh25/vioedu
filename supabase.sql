-- LỖI THỜI — KHÔNG CHẠY FILE NÀY.
-- Schema thật (groups / group_members / schedules có group_id, member_id) được
-- tạo trực tiếp trên Supabase và không khớp với nội dung bên dưới.
-- Policy quyền truy cập đang dùng nằm ở supabase-rls.sql.
